...
ExerciseHypothesis.create!([
  {exercise_id: 1, hypothesis_id: 5, explanation: "BSE:n tapauksessa kuolemat ovat yksittäistapauksia, toisin kun nyt. Eläinten käytöksessä ei ole ilmennyt pidemmällä aikavälillä mitään poikkeavaa (epänormaalia kiihtymystä tai poikkeavaa reagoimista ärsykkeisiin) ennen niiden kuolemaa."},
  ...
  {exercise_id: 1, hypothesis_id: 18, explanation: "Sähköisku tappaa heti. Näillä naudoilla oli edeltäviä oireita. Rakenteisiin päässyttä sähköä voisi mitata jännitemittareilla, mutta nyt ei ole edes siihen syytä."},
